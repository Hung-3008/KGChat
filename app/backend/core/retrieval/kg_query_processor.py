    ...
    async def process_query(
        ...
        try:
            ...
            if intent == QueryIntent.GREETING:
                ...
                kg_context["level1_nodes"] = expanded_level1
                kg_context["level2_nodes"] = expanded_level2

                kg_context["combined_text"] = format_retrieval_results(
                    expanded_level1,
                    expanded_level2,
                    relationships
                )
                ...
                logger.info(
                    f"Retrieved {len(level1_nodes)} Level 1 nodes and {len(level2_nodes)} Level 2 nodes")
                logger.info(
                    f"After expansion: {len(expanded_level1)} Level 1 nodes and {len(expanded_level2)} Level 2 nodes")
...
async def process_kg_query(
    ...
    # Create a processor instance with new parameters
